// src/app/dashboard/tradesperson/job-board/[id]/quote/page.tsx
...
export default async function QuotePage({ params }: QuotePageProps) {
  ...
  // ✅ Use centralized role helper instead of hard-coded array
  ...
  if (job.status !== "open") {
    redirect(`/dashboard/tradesperson/job-board/${id}?error=closed`);
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="subtle" size="sm" asChild>
          <Link href={`/dashboard/tradesperson/job-board/${id}`} className="flex items-center gap-2">
      ...
      {/* Re-introduced Two-Column Layout */}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-card border-border shadow-sm">
            ...
            <CardContent className="p-6">
              <SubmitQuoteForm jobId={id} tierOverride={tier as "basic" | "pro" | "business"} />
            </CardContent>
          </Card>
        </div>
